...
# read the emmissions data file for 1999, 2002, 2005, & 2008
NEI <- readRDS("summarySCC_PM25.rds")

# read the Source Classification Code Table - gives us a name of factor to use instead of binary code.
